---
name: root_foundation_rigor
trigger: When the user asks to "understand context", "design agent architecture", "debug context issues", "optimize context usage", or discusses context components, attention mechanics, progressive disclosure, or context budgeting.
source: Agent-Skills-for-Context-Engineering/skills/context-fundamentals/SKILL.md
---

# Context Engineering Fundamentals (Root Foundation Rigor)
