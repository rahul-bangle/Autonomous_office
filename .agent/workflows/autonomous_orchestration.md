...
trigger: When the user asks to "design multi-agent system", "implement supervisor pattern", "create swarm architecture", "coordinate multiple agents", or mentions multi-agent patterns, context isolation, agent handoffs, sub-agents, or parallel agent execution.
source: Agent-Skills-for-Context-Engineering/skills/multi-agent-patterns/SKILL.md
---

# Multi-Agent Architecture Patterns (Autonomous Orchestration)
